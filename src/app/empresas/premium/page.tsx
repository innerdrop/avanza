                            ...
                            <div className="flex-1">
                                ...
                                <div className="bg-white rounded-xl p-5 border border-amber-200">
                                    ...
                                    <p className="text-xs text-slate-500 mt-3">
                                        📋 Una vez realizada la transferencia, envía el comprobante por WhatsApp o email.
                                        Activaremos tu Premium en menos de 24 horas.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="mt-16 text-center">
                    ...
                    <div className="max-w-2xl mx-auto space-y-4 text-left">
                        <div className="bg-white rounded-xl p-5 shadow-md border border-slate-200">
                            <h3 className="font-bold text-slate-800 mb-2">¿Cómo funciona el análisis de CV con IA?</h3>
                            <p className="text-slate-600 text-sm">
                                Nuestra IA analiza automáticamente los CVs de los candidatos, extrae información clave como habilidades, experiencia, educación y genera un resumen profesional para facilitar tu evaluación.
                            </p>
                        </div>
                        <div className="bg-white rounded-xl p-5 shadow-md border border-slate-200">
                            <h3 className="font-bold text-slate-800 mb-2">¿Qué es la búsqueda de talento con IA?</h3>
                            <p className="text-slate-600 text-sm">
                                Con un solo clic, la IA compara todos los candidatos analizados en nuestra base de datos con tu oferta de empleo y te muestra el mejor match con un puntaje de compatibilidad y recomendaciones.
                            </p>
                        </div>
                        <div className="bg-white rounded-xl p-5 shadow-md border border-slate-200">
                            <h3 className="font-bold text-slate-800 mb-2">¿Puedo cancelar en cualquier momento?</h3>
                            <p className="text-slate-600 text-sm">
                                Sí, puedes cancelar tu suscripción Premium en cualquier momento. Mantendrás el acceso hasta el final de tu período de facturación actual.
                            </p>
                        </div>
                    </div>
                </div>
